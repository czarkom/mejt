  ...
  return (
    <div className="max-w-6xl mx-auto p-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800">Boat Logbook</h1>
        <button
      ...
      {showForm && (
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Add New Log Entry</h2>
          <form onSubmit={addLogEntry} className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  placeholder="Harbor, coordinates, etc."
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  placeholder="Sunny, 15 knots SW, etc."
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="Describe your trip, activities, observations, maintenance, etc."
                required
              />
            </div>
      ...
      <div className="space-y-6">
        {loading ? (
          <div className="text-center py-8">
            <p className="text-gray-600">Loading log entries...</p>
          </div>
        ) : logs.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-gray-600 mb-4">No log entries yet.</p>
            <button
            ...
            <div key={log.id} className="bg-white rounded-lg shadow-md p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="text-right text-sm text-gray-500">
                  <p>Added: {formatDate(log.created_at)}</p>
                </div>
              </div>
              ...
              {(log.location || log.weather) && (
                <div className="flex flex-wrap gap-4 mb-4 text-sm">
                  ...
                  {log.weather && (
                    <div className="flex items-center">
                      <span className="font-medium text-gray-600">🌤️ Weather:</span>
